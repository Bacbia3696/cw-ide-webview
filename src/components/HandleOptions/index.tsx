...
const HandleOptions = ({ handleOptionsRef }) => {
  const onHandleOptionsChange = _.throttle(
    ({ formData }) => {
      setHandleOptions(formData);
      handleOptionsRef.current = {
        ...formData,
        funds: formData.funds.slice(1),
      }; // always skip the first index because it is a placeholder
    },
    2000,
    { trailing: true }
  );
  ...
  return (
    <div className="input-form">
      <Form
        schema={handleOptionsSchema as any}
        validator={validator}
